...
typealias completionBlock=((videoPath: NSURL?, error: NSError?) -> Void)

class VideoCutter: NSObject {

    func cropVideoWithUrl(videoUrl url: NSURL, startTime:CGFloat,duration:CGFloat,completion:completionBlock?) {
